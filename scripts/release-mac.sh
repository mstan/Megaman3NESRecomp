...
REPO_NAME="Megaman3NESRecomp"      # GitHub repo / zip basename
APP_NAME="Mega Man 3"        # .app display name (may contain spaces)
TARGET="MegaMan3Recomp"            # cmake target == built binary filename in build-mac/
SYSTEM="nes"            # nes | snes | genesis | vb | psx
VERSION="v0.0.1-macos"          # release tag, e.g. v0.1.0-macos
ROM_HINT="Mega Man 3 (USA) .nes dump"        # human description of the ROM the user must supply
# ==============================================
