"""Trace RAM $FD (scroll nametable source) on both native and emulated.
Set up follower on native to catch writes with call stack."""
...
print("Waiting 12s for both builds to reach stage...")
time.sleep(12)
